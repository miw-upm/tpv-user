...
* Necesita de una bases de datos: **url:** `jdbc:postgresql://localhost:5432/tpvuser`, **username:**`postgres` y *
  *password:** `postgres`. Recordar que la BD **tpvuser** se deben crear manualmente.
